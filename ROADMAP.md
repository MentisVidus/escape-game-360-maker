...
| C23 | Persistance bundle médias (audio + image) | v1.12 | Annexe B — C23, `docs/archives/chantier_23.md` |
...
### 1. C22 — Hotspots responsives *(scaling proportionnel à l'image)*
...
### 2. C20 — Aperçus latéraux globaux
...
### 3. C21 — End-screens scene-level via clic droit
...
### 4. C11 — Déploiement Netlify intégré
...
### 5. C12 — Logique de jeu : conditions et combinaisons
...
### 6. C13 — Logique de jeu temporelle
...
### 7. C14 — Bibliothèques productivité éditeur
...
### 10. C17 — Médias partagés et portables
