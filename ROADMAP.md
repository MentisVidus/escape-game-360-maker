...
### 2. C23 — Persistance bundle audio *(global + ambient + reconnexion blob au reload)*
...
### 3. C22 — Hotspots responsives *(scaling proportionnel à l'image)*
...
### 4. C20 — Aperçus latéraux globaux
...
### 5. C21 — End-screens scene-level via clic droit
...
### 6. C11 — Déploiement Netlify intégré
...
### 7. C12 — Logique de jeu : conditions et combinaisons
...
### 8. C13 — Logique de jeu temporelle
...
### 9. C14 — Bibliothèques productivité éditeur
...
### 12. C17 — Médias partagés et portables
