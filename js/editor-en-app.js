...
function updateHsFields(hId, opts) {
    ...
    if(type === 'msg') {
        ...
        <select class="f-req-action" onchange="document.getElementById('req_res_${hId}').className = 'res-' + this.value">
            <option value="scene"${reqRewardType === "scene" ? " selected" : ""}>Change scene</option><option value="msg"${reqRewardType === "msg" ? " selected" : ""}>Show message</option><option value="pick"${reqRewardType === "pick" ? " selected" : ""}>Give new item</option>
            <option value="selector"${reqRewardType === "selector" ? " selected" : ""}>Open choice menu (selector)</option>
        </select>
        ...
        <select class="f-pwd-action" onchange="document.getElementById('pwd_res_${hId}').className = 'res-' + this.value">
            <option value="scene"${pwdRewardType === "scene" ? " selected" : ""}>Change scene</option><option value="msg"${pwdRewardType === "msg" ? " selected" : ""}>Show message</option><option value="pick"${pwdRewardType === "pick" ? " selected" : ""}>Give item</option>
            <option value="selector"${pwdRewardType === "selector" ? " selected" : ""}>Open choice menu (selector)</option>
        </select>
