...
<script>
    ...
    function rewardNodeToArgs(node, depth) {
        if(!node || typeof node !== "object") return { action: "scene", target: "", transTxt: "", transBtn: "Continuer" };
        ...
        if(act === "scene") {
            ...
            out.transBtn = node.transBtn || node.f_trans_btn || "Continuer";
            return out;
        }
        if(act === "msg") {
        ...
        return { action: "scene", target: "", transTxt: "", transBtn: "Continuer" };
    }
    ...
    function executeReward(args, hsDiv) {
        ...
        if(act === "scene") {
            ...
            cls2.innerHTML = "X";
            cls2.setAttribute("aria-label", "Fermer");
