 ...
 * @param {object|null} rewardAction — null supprime rewardAction du payload
 */
...
/** Chemin B : copie un hotspot (tout type) vers une autre scène (index DOM). */
...
/**
 * Chemin B : met à jour le volume depuis un nœud ressource de la carte React.
 * opts : { resourceType, volume, sceneIndex?, hotspotIndex?, choicePath? }
 */
...
/** Chemin B (carte React) : applique url/volume SFX sur un choix du menu selector. */
...
/** Chemin B : carte du choix selector (DOM) à partir du chemin d’indices. */
...
/**
 * Chemin B (carte React) : définit l’action « Aller à une scène » sur un choix du menu (id scène = valeur .sc-id).
 */
...
/** Chemin B : même effet que ci-dessus, cible lue depuis l’index de bloc scène (DOM). */
