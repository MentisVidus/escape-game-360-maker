...
| [plan_sauvegarde_locale_joueur.md](./plan_sauvegarde_locale_joueur.md) | **Progression joueur** : sauvegarde locale IndexedDB, export/import manuel de sauvegarde, reprise depuis écran titre — *planification* |
