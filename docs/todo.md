...
- **Formulaire scène** — regrouper ambiance + volume + timer local dans un `<details>` replié par défaut (`<!-- TODO(UX) -->` dans les gabarits `addScene` FR/EN).
